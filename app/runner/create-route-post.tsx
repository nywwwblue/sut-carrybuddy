...
export default function CreateRoutePost() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* 🛠️ ย้ายกลุ่ม Header มาอยู่นอก ScrollView เพื่อให้ปุ่มย้อนกลับชิดขอบจออย่างสมบูรณ์แบบ */}
      <View style={styles.headerBox}>
        <TouchableOpacity style={styles.backBtn} onPress={() => router.back()} activeOpacity={0.7}>
          <Ionicons name="arrow-back" size={20} color="#3A2113" />
        </TouchableOpacity>
        <View style={styles.headerInfo}>
          <Text style={styles.headerTitle}>สร้างประกาศรับหิ้ว</Text>
          <Text style={styles.headerSubtitle}>ระบุรายละเอียดเส้นทางวิ่งงานใน มทส.</Text>
        </View>
      </View>

      {/* ส่วนกรอกข้อมูลหลักแยกอิสระ */}
